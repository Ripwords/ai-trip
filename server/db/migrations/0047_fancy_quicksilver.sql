...
UPDATE "flights" SET "actual_departure_time" = "departure_time", "actual_arrival_time" = "arrival_time" WHERE "raw_api_response" IS NULL AND "status" = 'landed';--> statement-breakpoint
UPDATE "flights" SET "scheduled_departure_time" = "departure_time", "scheduled_arrival_time" = "arrival_time" WHERE "raw_api_response" IS NULL AND "status" <> 'landed';--> statement-breakpoint
