    ...
    if (freshData) {
      const [updated] = await db
        ...
        .set({
          ...
          scheduledDepartureTime: freshData.scheduledDepartureTime,
          actualDepartureTime: freshData.actualDepartureTime,
          scheduledArrivalTime: freshData.scheduledArrivalTime,
          actualArrivalTime: freshData.actualArrivalTime,
