 ...
 */
const SCRIPT =
  `(function(){try{var m=document.cookie.match(/theme-mode=([^;]+)/);var v=m?m[1]:"system";var d=v==="dark"||(v==="system"&&window.matchMedia("(prefers-color-scheme:dark)").matches);if(d)document.documentElement.classList.add("dark")}catch(e){}})()`.trim()
