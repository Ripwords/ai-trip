...
export function buildInsertRow(
  ...
  if (looked) {
    return {
      ...
      scheduledDepartureTime: looked.scheduledDepartureTime ?? row.scheduledDepartureTime,
      actualDepartureTime: looked.actualDepartureTime ?? row.actualDepartureTime,
      scheduledArrivalTime: looked.scheduledArrivalTime ?? row.scheduledArrivalTime,
      actualArrivalTime: looked.actualArrivalTime ?? row.actualArrivalTime,
