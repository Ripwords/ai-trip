...
const theme = computed(() =>
  isDark.value
    ? {
        ...
        overlayBg: "rgba(26, 23, 20, 0.92)",
        overlayBorder: "rgba(255, 255, 255, 0.1)",
        overlayText: "#c8d6e5",
        overlayAccent: "#f07b5a",
        layoverAccent: "#7dc3d4",
        wantAccent: "#a78bfa",
        btnBg: "rgba(30, 48, 68, 0.85)",
        btnText: "#c8d6e5",
        btnHover: "rgba(42, 68, 96, 0.95)",
        tooltipBg: "#2d4560",
        tooltipText: "#e2e8f0",
    ...
    : {
        ...
        overlayBg: "rgba(250, 248, 245, 0.92)",
        overlayBorder: "rgba(0, 0, 0, 0.08)",
        overlayText: "#3d3328",
        overlayAccent: "#d44425",
        layoverAccent: "#2e8a9e",
        wantAccent: "#7c3aed",
        btnBg: "rgba(250, 248, 245, 0.82)",
        btnText: "#5a4b3a",
        btnHover: "rgba(250, 248, 245, 1)",
        tooltipBg: "#3d3328",
        tooltipText: "#faf8f5",
        tooltipBadgeBg: "rgba(255, 255, 255, 0.18)",
      },
)
