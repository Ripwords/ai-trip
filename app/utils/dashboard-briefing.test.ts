...
describe("dashboard briefing", () => {
    ...
    const flights = [
      {
        ...
        scheduledDepartureTime: "2026-06-08T11:15:00.000Z",
        actualDepartureTime: null,
        scheduledArrivalTime: "2026-06-08T12:20:00.000Z",
      ...
      flights: [
        {
          ...
          scheduledDepartureTime: "2026-06-07T00:20:00.000Z",
          actualDepartureTime: null,
          scheduledArrivalTime: "2026-06-07T05:10:00.000Z",
          actualArrivalTime: null,
          terminal: "1",
          gate: null,
          status: "scheduled",
        },
        {
          ...
          scheduledDepartureTime: "2026-06-07T08:20:00.000Z",
          actualDepartureTime: null,
          scheduledArrivalTime: "2026-06-07T11:40:00.000Z",
          actualArrivalTime: null,
          terminal: null,
          gate: null,
          status: "scheduled",
      ...
      flights: [
        {
          ...
          scheduledDepartureTime: "2026-06-07T11:15:00.000Z",
          actualDepartureTime: null,
          scheduledArrivalTime: "2026-06-07T12:20:00.000Z",
          actualArrivalTime: null,
          terminal: "2",
          gate: null,
          status: "scheduled",
        },
        {
          ...
          scheduledDepartureTime: "2026-06-07T14:20:00.000Z",
          actualDepartureTime: null,
          scheduledArrivalTime: "2026-06-07T20:40:00.000Z",
          actualArrivalTime: null,
          terminal: null,
          gate: null,
          status: "scheduled",
        },
        {
          ...
          scheduledDepartureTime: "2026-06-12T11:00:00.000Z",
          actualDepartureTime: null,
          scheduledArrivalTime: "2026-06-12T17:20:00.000Z",
          actualArrivalTime: null,
          terminal: null,
          gate: null,
          status: "scheduled",
        },
        {
          ...
          scheduledDepartureTime: "2026-06-12T19:10:00.000Z",
          actualDepartureTime: null,
          scheduledArrivalTime: "2026-06-12T20:15:00.000Z",
          actualArrivalTime: null,
          terminal: null,
          gate: null,
          status: "scheduled",
  ...
  it("judges a connection on one clock, never on a real arrival against a booked departure", () => {
    // The inbound diverted and landed two days late; the onward leg has no
    // actual departure yet. Subtracting the booked departure from the real
    // arrival puts the two legs 36 hours apart in the wrong direction and
    // severs the itinerary, so SIN stops counting as a layover at all.
    const briefing = buildPreTripBriefing({
      trip: trip(),
      today,
      flights: [
        {
          ...
          arrivalAirport: "SIN",
          departureTime: "2026-06-07T11:15:00.000Z",
          arrivalTime: "2026-06-09T02:00:00.000Z",
          scheduledDepartureTime: "2026-06-07T11:15:00.000Z",
          actualDepartureTime: "2026-06-07T11:15:00.000Z",
          scheduledArrivalTime: "2026-06-07T12:20:00.000Z",
          actualArrivalTime: "2026-06-09T02:00:00.000Z",
          terminal: "2",
          gate: null,
          status: "delayed",
        },
    ...
    assert.ok(briefing)
    assert.ok(briefing.chips.some((chip) => chip.label === "Layover: SG"))
  })
})
